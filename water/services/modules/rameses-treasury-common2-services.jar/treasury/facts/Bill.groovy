...
public class Bill {
    ...
    public Bill( def o ) {
		...
		if(o.duedate) this.duedate = o.duedate;
    }

    public def toMap() {
    	def map = [:];
		map.objid =  this.objid;
		map.state =  this.state;
		map.paymentmode =  this.paymentmode;
		map.balanceforward =  this.balanceforward;
		map.amount =  this.amount;
		map.billdate =  this.billdate;
		map.validitydate =  this.validitydate;
		map.expirydate =  this.expirydate;
