...
dtemp.reportid,
CASE WHEN NOT(dtemp.template IS NULL) THEN dtemp.template ELSE rpt.template END AS template,  
dtemp.endorserid AS endorserid,
dtemp.approverid AS approverid,
...
from obo_app_doc a 
	...
	left join obo_doctype dtemp on iss.doctypeid = dtemp.objid 
go 